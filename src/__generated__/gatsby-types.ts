...
type usersaleksandarWebDevgatsbyStarterTemplatesrchooksuseSiteMetadataTs26013859QueryVariables = Exact<{ [key: string]: never; }>;


type usersaleksandarWebDevgatsbyStarterTemplatesrchooksuseSiteMetadataTs26013859Query = { readonly site: Maybe<{ readonly siteMetadata: Maybe<Pick<SiteSiteMetadata, 'author' | 'description' | 'keywords' | 'siteUrl' | 'title'>> }> };
